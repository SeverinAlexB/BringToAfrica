...
alter table donation_goal add constraint fk_donation_goal_type_4 foreign key (type_id) references donation_type (id);
...
alter table Project add constraint fk_Project_owner_7 foreign key (owner_id) references AfrikaUser (id);
